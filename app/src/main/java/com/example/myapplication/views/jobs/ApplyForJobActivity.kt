    ...
    Column(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Button(
                onClick = {
                try {
                    val expectedPayInt = expectedPayText.takeIf { it.isNotBlank() }?.toIntOrNull()
                    ...
                    Toast.makeText(context, applicationsViewModel.uploadState.value, Toast.LENGTH_SHORT).show()
                    ...
                    Log.d("Debugiranje!", applicationsViewModel.uploadState.value.toString())
